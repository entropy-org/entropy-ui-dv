...
const records: readonly FixtureRecord[] = [
  { id: "react-18", title: "Minimum supported React", status: "ready" },
]
...
const initialViews: readonly SavedDataView[] = [
  createSavedDataView({
    id: "all",
    name: "All",
    definition: { type: "list", showColumnHeaders: true },
  }),
]
...
function App() {
  ...
  const plugins = useMemo(
    () => createBuiltInDataViewPlugins<FixtureRecord>(),
    []
  )
  return (
    <DatabaseViews
      source={{ mode: "client", id: "react-18", records }}
      schema={schema}
      views={views}
      activeViewId="all"
